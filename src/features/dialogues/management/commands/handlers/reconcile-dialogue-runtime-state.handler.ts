...
} from '../impl/reconcile-dialogue-runtime-state.command.js';

@CommandHandler(ReconcileDialogueRuntimeStateCommand)
export class ReconcileDialogueRuntimeStateHandler implements ICommandHandler<
  ReconcileDialogueRuntimeStateCommand,
  ReconcileDialogueRuntimeStateCommandReturnType
> {
  constructor(
