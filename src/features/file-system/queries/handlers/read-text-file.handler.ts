...
} from '../impl/read-text-file.query.js';

@QueryHandler(ReadTextFileQuery)
export class ReadTextFileHandler implements IQueryHandler<
  ReadTextFileQuery,
  ReadTextFileQueryReturnType
> {
  constructor(
  ...
  async execute(query: ReadTextFileQuery): Promise<ReadTextFileQueryReturnType> {
