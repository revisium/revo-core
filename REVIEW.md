...
- REST and GraphQL adapters consume that projection and contain no feature branches, business checks, or duplicate payload validation. Adding a public application error updates its feature contract, catalog entry, projection allowlist, and mixed-transport boundary test while preserving existing path, field, absent, and null behavior.
